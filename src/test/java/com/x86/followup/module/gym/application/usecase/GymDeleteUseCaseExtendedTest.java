...
@DisplayName("GymDeleteUseCase Unit Tests")
class GymDeleteUseCaseTest {
    ...
    @Test
    @DisplayName("Should handle deletion of different gym IDs")
    void testDeleteMultipleGyms() {
        // Test deletion handling
        verify(repository, times(0)).delete(any(GymId.class));
    }
}
